...
---
En este *post* explicaré cómo usar la herramienta *Taxon Match* del *World Register of Marine Species* - (<img src = "\files\svg\Worms.svg" alt="Mi SVG feliz" width="100px" height="50px"/>), una herramienta automática para verificar la validez y la correcta escritura de los nombres de las especies, basada en el código **APHIA**.
<!--more-->
