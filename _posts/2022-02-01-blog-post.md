...
<div style="text-align:center"><a href="https://www.marinespecies.org/aphia.php?p=match" target="_blank"><img src="/images/worms/worms05.png" style="width: 75%" aling="center"/></a></div>
...
El **quinto** paso es la selección del botón de chequeo "*Match authority*" cuando se tiene una columna específica donde están los datos de autoridad del taxón y se desea evauar una coincidencia para este dato.
...
El **septimo** paso es deidir si las coincidencias en la lista se limitan a un taxón superior al género exclusivamente (*e.g.* Porifera, Chromista), el cual se puede escribir y escoger de la posterior lista que se autodepliega en la entrada llamada *Limit to taxa belonging to*.
